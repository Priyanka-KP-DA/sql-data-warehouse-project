...
BEGIN
	...
	PRINT '>> Rows Inserted: ' + CAST(@rows_loaded AS NVARCHAR);
	...
	PRINT '>> Inserting Data into: silver.crm_sales_details'
			...
			sls_cust_id ,
				...
				END AS sls_sales,
			sls_quantity,
				CASE WHEN sls_price <= 0 OR sls_price IS NULL OR sls_price <= 0
	...
	PRINT '>> Inserting Data into: silver.erp_cust_az12'
			...
			SELECT
			    ...
			    END AS BDATE,
			    CASE
			        WHEN UPPER(REPLACE(LTRIM(RTRIM(GEN)), CHAR(13), '')) IN ('F', 'FEMALE') THEN 'Female'
			        WHEN UPPER(REPLACE(LTRIM(RTRIM(GEN)), CHAR(13), '')) IN ('M', 'MALE') THEN 'Male'
			        ELSE 'n/a'
			    END AS GEN
	...
	PRINT '>> Inserting Data into: silver.erp_px_cat_g1v2'    
			...
			cat,
			subcat,
			TRIM(REPLACE(REPLACE(REPLACE (maintenance, CHAR(13), ''), CHAR(10), ''), CHAR(9), '')) AS maintenance
